...
HakiDecor2AddOn::HakiDecor2AddOn(image_id id, const char* name)
	:
	DecorAddOn(id, name)
{
}
...
Decorator*
HakiDecor2AddOn::_AllocateDecorator(DesktopSettings& settings, BRect rect,
	Desktop* desktop)
{
	return new (std::nothrow)HakiDecorator2(settings, rect, desktop);
}


//	#pragma mark - HakiDecorator2
...
*/
HakiDecorator2::HakiDecorator2(DesktopSettings& settings, BRect rect,
	Desktop* desktop)
	:
...
HakiDecorator2::~HakiDecorator2()
{
	STRACE(("HakiDecorator2: ~HakiDecorator2()\n"));
...
void
HakiDecorator2::_DrawFrame(BRect invalid)
{
			...
			//	r.bottom -= 2;
				...
				if (IsFocus(fTopTab)) {
					...
					fDrawingEngine->StrokeLine(r.LeftBottom(), r.RightBottom(),
						fFrameLowerColor);
					fDrawingEngine->StrokeLine(r.RightBottom(), r.RightTop(),
						fFrameLowerColor);
...
*/
void
HakiDecorator2::_DrawTab(Decorator::Tab* tab, BRect invalid)
{
...
*/
void
HakiDecorator2::_DrawTitle(Decorator::Tab* _tab, BRect r)
{
...
*/
void
HakiDecorator2::_DrawClose(Decorator::Tab* _tab, bool direct, BRect rect)
{
...
*/
void
HakiDecorator2::_DrawZoom(Decorator::Tab* _tab, bool direct, BRect rect)
{
...
void
HakiDecorator2::_DrawMinimize(Decorator::Tab* tab, bool direct, BRect rect)
{
...
void
HakiDecorator2::_GetButtonSizeAndOffset(const BRect& tabRect, float* _offset,
...
{
	return new (std::nothrow)HakiDecor2AddOn(id, name);
}
