...
//     #pragma mark - HakiGameLDecorAddOn


HakiGameLDecorAddOn::HakiGameLDecorAddOn(image_id id, const char* name)
	:
	DecorAddOn(id, name)
{
}
...
Decorator*
HakiGameLDecorAddOn::_AllocateDecorator(DesktopSettings& settings, BRect rect,
	Desktop* desktop)
{
	return new (std::nothrow)HakiGameLDecor(settings, rect, desktop);
}


//	#pragma mark - HakiGameLDecor


HakiGameLDecor::HakiGameLDecor(DesktopSettings& settings, BRect rect,
	Desktop* desktop)
	:
	...
	fFrameHighColor((rgb_color) { 52, 151, 34, 255 }), //green
	fFrameMidColor((rgb_color) { 40, 125, 24, 255 }),
	fFrameLowColor((rgb_color) { 14, 51, 10, 255 }),
	fFrameLowerColor((rgb_color) { 0, 0, 0, 255 }),
	
	fFrameTitleHighColor ((rgb_color) { 52, 151, 34, 255 }), //green
	fFrameTitleMidColor ((rgb_color) { 40, 125, 24, 255 }),
	fFrameTitleLowColor ((rgb_color) { 14, 51, 10, 255 }),
...
HakiGameLDecor::~HakiGameLDecor()
{
	STRACE(("HakiGameLDecor: ~HakiGameLDecor()\n"));
...
*/
void
HakiGameLDecor::_DrawBevelRect(const BRect rect, bool down,
...
void
HakiGameLDecor::_DrawFrame(BRect invalid)
{
...
*/
void
HakiGameLDecor::_DrawTab(Decorator::Tab* tab, BRect invalid)
{
...
*/
void
HakiGameLDecor::_DrawTitle(Decorator::Tab* _tab, BRect r)
{
...
*/
void
HakiGameLDecor::_DrawClose(Decorator::Tab* _tab, bool direct, BRect rect)
{
...
*/
void
HakiGameLDecor::_DrawZoom(Decorator::Tab* _tab, bool direct, BRect rect)
{
...
void
HakiGameLDecor::_DrawMinimize(Decorator::Tab* tab, bool direct, BRect rect)
{
...
void
HakiGameLDecor::_GetButtonSizeAndOffset(const BRect& tabRect, float* _offset,
...
{
	return new (std::nothrow)HakiGameLDecorAddOn(id, name);
}
